...
@Composable
fun DateGroupsScreen(viewModel: ScriptListViewModel, navController: NavHostController) {
    ...
    Column(
        ...
        Button(
            modifier = Modifier
                ...
                .height(50.dp),
            onClick = {
                openChooseDatesDialog.value = true
            },
...
@Composable
fun DateGroupsItem(
    it: ScriptDetailsModel.RoomGroup.DayGroup,
            ...
            Row(
                ...
                Row(
                    ...
                    Icon(Icons.Default.Edit, "исправить", modifier = Modifier
                        .size(30.dp)
                        .clickable {
                            viewModel.indexSettingGroupStateFlow.value = index
                            navController.navigate("script/settings_groups")
                        })
                    Icon(
